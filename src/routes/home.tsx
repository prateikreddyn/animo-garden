    ...
    <main className="min-h-screen pb-16" style={{ background: "var(--gradient-sky)" }}>
      <div className="mx-auto w-full max-w-2xl px-5 pt-8">
        ...
        <section className="mt-6 rounded-3xl border border-border bg-card p-6 text-center shadow-[var(--shadow-soft)]">
          ...
          <h2 className="text-2xl font-semibold">{companionCopy[cs].title}</h2>
        ...
        <nav className="mt-6 space-y-4" aria-label="Main">
          ...
          <BigLink to="/caregiver" icon={<Users className="size-8" />} hint="For family and caregivers">
            Caregiver view
          </BigLink>
          <BigLink to="/settings" icon={<SettingsIcon className="size-8" />} hint="Text size, voice, privacy">
            Settings
          </BigLink>
        </nav>
      </div>
